<?php
// ✅ FIX: Agregado auth — antes cualquiera podía consultar precios y stock sin sesión
...
$stock = function_exists("obtenerStockDisponible")
  ? (int)obtenerStockDisponible($conexion, $id)
  : null;
